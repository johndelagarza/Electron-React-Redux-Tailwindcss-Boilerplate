...
export async function loadSavedData(collection) {
...
export async function saveDataInStorage(collection, newArray) {
...
// Remove an item
export async function removeDataFromStorage(collection, newArray) {
